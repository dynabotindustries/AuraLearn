...
// Web Speech API interfaces (to silence TS errors without external types)
...
const ChatBubble: React.FC<{ message: ChatMessage }> = ({ message }) => {
  ...
  return (
    <div className={`flex ${isModel ? 'justify-start' : 'justify-end'} my-2`}>
      <div
        className={`max-w-xl lg:max-w-2xl px-5 py-3 rounded-2xl whitespace-pre-wrap ${
          isModel
...
const TutorChat: React.FC<TutorChatProps> = ({
    ...
    try {
      ...
      for await (const chunk of stream) {
        ...
        if (firstChunk) {
          ...
          setChatHistory((prev) => [
            ...prev,
            { id: modelMessageId, role: 'model', text: fullText, sources },
          ]);
        } else {
          setChatHistory((prev) => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-8rem)] max-h-[calc(100vh-8rem)] animate-fade-in bg-gray-900">
      {/* Header */}
        ...
        <div className="relative flex items-center">
          ...
          <div className="absolute right-4 flex items-center space-x-2">
            ...
            <button
              ...
              className="p-2 text-white bg-blue-600 rounded-full hover:bg-blue-700 disabled:bg-gray-500 disabled:cursor-not-allowed"
            >
